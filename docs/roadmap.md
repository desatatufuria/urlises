...
| 2 | PR 2 | PR 1 branch | Auth, organizations, workspaces, canonical tree reads, role gates | Members can authenticate, access allowed workspaces, and read canonical trees with stable IDs/order | `README.md`, `docs/requeriments.md`, `docs/roadmap.md` |
| 3 | PR 3 | PR 2 branch | Transactional sync event log, replay API, websocket fan-out, idempotency rules | Accepted mutations write domain + event in one transaction and replay ordered events by cursor | `README.md`, `docs/requeriments.md`, `docs/roadmap.md` |
...
| 5 | PR 5 | PR 4 branch | Hardening, local developer stack, verification notes, final documentation pass | Local bring-up is documented end-to-end and verify can exercise the MVP foundation coherently | `README.md`, `docs/requeriments.md`, `docs/roadmap.md` |
