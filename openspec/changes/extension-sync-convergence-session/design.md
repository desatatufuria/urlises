...
`develop` is the established integration base: `... -> PR4a0a3b -> PR4a0b.1 -> PR4a0b.2 -> PR4a1`. Each slice is a single work-unit commit/stacked PR and stays below 400 changed additions plus deletions. PR4a1 and extension work are excluded.
...
No migration required. Deploy/rollback at the slice boundary; no feature flag or changed public endpoint is needed.

## Open Questions

None. Recalculate tasks before apply.
