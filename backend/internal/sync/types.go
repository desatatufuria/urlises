...
type Store interface {
	...
	PrepareBookmarkPatchTx(ctx context.Context, tx pgx.Tx, userID, bookmarkID string, input bookmarks.UpdateBookmarkInput) (bookmarks.PreparedBookmarkPatch, error)
